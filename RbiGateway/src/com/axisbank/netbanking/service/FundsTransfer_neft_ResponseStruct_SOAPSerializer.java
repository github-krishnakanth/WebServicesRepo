...
public class FundsTransfer_neft_ResponseStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public void initialize(InternalTypeMappingRegistry registry) throws java.lang.Exception {
        ns2_myReceipt_SOAPSerializer = (CombinedSerializer)registry.getSerializer(SOAPConstants.NS_SOAP_ENCODING, com.axisbank.netbanking.service.Receipt.class, ns2_receipt_TYPE_QNAME);
    }
    
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        SOAPDeserializationContext context) throws java.lang.Exception {
        com.axisbank.netbanking.service.FundsTransfer_neft_ResponseStruct instance = new com.axisbank.netbanking.service.FundsTransfer_neft_ResponseStruct();
        com.axisbank.netbanking.service.FundsTransfer_neft_ResponseStruct_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_result_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.axisbank.netbanking.service.FundsTransfer_neft_ResponseStruct_SOAPBuilder();
                    }
                    state = registerWithMemberState(instance, state, member, myRESULT_INDEX, builder);
                    isComplete = false;
                } else {
                    instance.setResult((com.axisbank.netbanking.service.Receipt)member);
                }
                reader.nextElementContent();
            } else {
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.axisbank.netbanking.service.FundsTransfer_neft_ResponseStruct instance = (com.axisbank.netbanking.service.FundsTransfer_neft_ResponseStruct)obj;
