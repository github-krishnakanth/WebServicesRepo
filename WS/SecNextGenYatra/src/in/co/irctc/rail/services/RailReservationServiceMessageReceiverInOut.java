 ...
 */
        ...
        */
        ...
        public class RailReservationServiceMessageReceiverInOut extends org.apache.axis2.receivers.AbstractInOutMessageReceiver{
        ...
        if((op.getName() != null) && ((methodName = org.apache.axis2.util.JavaUtils.xmlNameToJavaIdentifier(op.getName().getLocalPart())) != null)){
            ...
            if("bookTicket".equals(methodName)){
                ...
                in.co.irctc.rail.types.Ticket ticket7 = null;
	                        in.co.irctc.rail.types.ReservationIn wrappedParam =
                                                             (in.co.irctc.rail.types.ReservationIn)fromOM(
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                        ...
                                        envelope = toEnvelope(getSOAPFactory(msgContext), ticket7, false, new javax.xml.namespace.QName("http://irctc.co.in/rail/services",
                                                    "bookTicket"));
        ...
        static {
            ...
            in.co.irctc.rail.types.ReservationIn.class,
                        in.co.irctc.rail.types.Ticket.class,
                        in.co.irctc.rail.types.ReservationFailedFault.class
				);
            }
                ...
                private org.apache.axiom.om.OMElement toOM(in.co.irctc.rail.types.ReservationIn param, boolean optimizeContent, javax.xml.namespace.QName methodQName)
                throws org.apache.axis2.AxisFault {
                    try {
                        ...
                        JaxbRIDataSource source = new JaxbRIDataSource( in.co.irctc.rail.types.ReservationIn.class,
                                                                        param,
                                                                        marshaller,
                    ...
                    throws org.apache.axis2.AxisFault {
                        try {
                            ...
                            JaxbRIDataSource source = new JaxbRIDataSource( in.co.irctc.rail.types.ReservationIn.class,
                                                                            param,
                                                                            marshaller,
                                                                            "http://irctc.co.in/rail/types",
                                                                            "reservationIn");
                            org.apache.axiom.om.OMNamespace namespace = factory.createOMNamespace("http://irctc.co.in/rail/types", null);
                ...
                private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, in.co.irctc.rail.types.ReservationIn param, boolean optimizeContent, javax.xml.namespace.QName methodQName)
                throws org.apache.axis2.AxisFault {
                ...
                private org.apache.axiom.om.OMElement toOM(in.co.irctc.rail.types.Ticket param, boolean optimizeContent, javax.xml.namespace.QName methodQName)
                throws org.apache.axis2.AxisFault {
                    try {
                        javax.xml.bind.JAXBContext context = wsContext;
                        javax.xml.bind.Marshaller marshaller = context.createMarshaller();
                        ...
                        JaxbRIDataSource source = new JaxbRIDataSource( in.co.irctc.rail.types.Ticket.class,
                                                                        param,
                                                                        marshaller,
                                                                        methodQName.getNamespaceURI(),
                                                                        methodQName.getLocalPart());
                ...
                private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, in.co.irctc.rail.types.Ticket param, boolean optimizeContent, javax.xml.namespace.QName methodQName)
                throws org.apache.axis2.AxisFault {
                    org.apache.axiom.soap.SOAPEnvelope envelope = factory.getDefaultEnvelope();
                    envelope.getBody().addChild(toOM(param, optimizeContent, methodQName));
                    return envelope;
                ...
                private org.apache.axiom.om.OMElement toOM(in.co.irctc.rail.types.ReservationFailedFault param, boolean optimizeContent, javax.xml.namespace.QName methodQName)
                throws org.apache.axis2.AxisFault {
                    try {
                        javax.xml.bind.JAXBContext context = wsContext;
                        javax.xml.bind.Marshaller marshaller = context.createMarshaller();
                        ...
                        JaxbRIDataSource source = new JaxbRIDataSource( in.co.irctc.rail.types.ReservationFailedFault.class,
                                                                        param,
                                                                        marshaller,
                                                                        methodQName.getNamespaceURI(),
                                                                        methodQName.getLocalPart());
                ...
                private org.apache.axiom.om.OMElement toOM(in.co.irctc.rail.types.ReservationFailedFault param, boolean optimizeContent)
                    throws org.apache.axis2.AxisFault {
                        try {
                            javax.xml.bind.JAXBContext context = wsContext;
                            javax.xml.bind.Marshaller marshaller = context.createMarshaller();
                ...
                private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, in.co.irctc.rail.types.ReservationFailedFault param, boolean optimizeContent, javax.xml.namespace.QName methodQName)
                throws org.apache.axis2.AxisFault {
                    org.apache.axiom.soap.SOAPEnvelope envelope = factory.getDefaultEnvelope();
                    envelope.getBody().addChild(toOM(param, optimizeContent, methodQName));
                    return envelope;
