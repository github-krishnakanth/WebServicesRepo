...
public class BookInfo_getBookPrice_RequestStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public BookInfo_getBookPrice_RequestStruct_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        com.wp.service.BookInfo_getBookPrice_RequestStruct instance = new com.wp.service.BookInfo_getBookPrice_RequestStruct();
        com.wp.service.BookInfo_getBookPrice_RequestStruct_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_String_1_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.wp.service.BookInfo_getBookPrice_RequestStruct_SOAPBuilder();
                    }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.wp.service.BookInfo_getBookPrice_RequestStruct instance = (com.wp.service.BookInfo_getBookPrice_RequestStruct)obj;
